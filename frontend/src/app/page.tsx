      ...
      <section className="relative flex h-[60vh] items-center justify-center text-center">
        ...
        <div className="relative z-10 p-4">
          <h1 className="font-headline text-5xl font-bold tracking-tight text-primary md:text-7xl">
            {isLoggedIn ? `Welcome back, ${user?.first_name || 'User'}!` : 'Book top restaurants'}
          </h1>
          <p className="mt-4 text-xl text-foreground/80 md:text-2xl">
            {isLoggedIn ? 'Discover amazing dining experiences' : 'with up to 50% off'}
          </p>
          {!isLoggedIn ? (
            ...
            <div className="text-center">
              ...
              <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
                <div className="text-center">
                  ...
                  <h3 className="mt-4 text-lg font-medium text-gray-900">Quick Reservations</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="mt-4 text-lg font-medium text-gray-900">Exclusive Deals</h3>
                  <p className="mt-2 text-sm text-gray-600">
